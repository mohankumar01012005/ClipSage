      ...
      <section className="relative min-h-screen w-full flex flex-col items-center justify-start text-center overflow-hidden">
        ...
        <div className="mt-40 max-w-3xl flex flex-col items-center px-6">
          <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 animate-fade-in">
            ...
            <span
              className={`bg-gradient-to-r from-blue-600 h-20 to-blue-400 bg-clip-text text-transparent inline-block transition-opacity duration-500 ease-in-out ${
          ...
          <p className="text-lg md:text-xl text-gray-600 mt-6 max-w-2xl animate-fade-in-delay">
            ClipSage understands your videos the way you wish you could. Ask any
            question and jump instantly to the exact moment that matters. Powered
            by advanced AI that transforms long tutorials into actionable insight.
          </p>
